...
#ifndef QTARFILETYPE_H_
#define QTARFILETYPE_H_
...
/**
 * @class QTarFileType
 * @brief Class to handle files in TAR archives
 *
 * This class use quazip for reading TAR files.
 *
 */
class QTarFileType : public QFileType {
	public:
		/**
		 * @brief Construct the TAR file handler
		 * @param fileInfo Information about the file
		 */
		QTarFileType(QMultiFileInfo& fileInfo);
		~QTarFileType();
