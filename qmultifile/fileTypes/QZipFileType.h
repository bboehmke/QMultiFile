...
#ifndef QZIPFILETYPE_H_
#define QZIPFILETYPE_H_
...
/**
 * @class QZipFileType
 * @brief Class to handle files in ZIP archives
 *
 * This class use quazip for reading ZIP files.
 *
 */
class QZipFileType : public QFileType {
	public:
		/**
		 * @brief Construct the ZIP file handler
		 * @param fileInfo Information about the file
		 */
		QZipFileType(QMultiFileInfo& fileInfo);
		~QZipFileType();
